...
public interface PSApiService {
    ...
    LiveData<ApiResponse<List<com.macinternetservices.sablebusinessdirectory.viewobject.Comment>>> getCommentList(@Path("API_KEY") String apiKey, @Path("item_id") String itemId, @Path("limit") String limit, @Path("offset") String offset);
    ...
    LiveData<ApiResponse<List<com.macinternetservices.sablebusinessdirectory.viewobject.CommentDetail>>> getCommentDetailList(@Path("API_KEY") String apiKey, @Path("header_id") String headerId, @Path("limit") String limit, @Path("offset") String offset);
