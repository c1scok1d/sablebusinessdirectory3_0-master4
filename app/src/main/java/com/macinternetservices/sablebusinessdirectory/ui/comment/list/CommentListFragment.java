package com.macinternetservices.sablebusinessdirectory.ui.comment.list;
...
import com.macinternetservices.sablebusinessdirectory.databinding.FragmentCommentListBinding;
import com.macinternetservices.sablebusinessdirectory.ui.comment.list.adapter.CommentListAdapter;
...
//        });
        ...
        binding.get().sendImageButton.setOnClickListener(view -> {
            ...
            if (!commentListViewModel.isLoading) {
                ...
                Utils.navigateOnUserVerificationActivity(userIdToVerify, loginUserId, psDialogMsg, this.getActivity(), navigationController, new Utils.NavigateOnUserVerificationActivityCallback() {
                    @Override
    ...
    protected void initViewModels() {
        commentListViewModel = new ViewModelProvider(this, viewModelFactory).get(CommentListViewModel.class);
    }
    ...
    private void sendComment() {
        ...
        if (description.equals("")) {
            ...
            prgDialog.get().show();
            commentListViewModel.setSendCommentHeaderPostDataObj(commentListViewModel.itemId, loginUserId, description, selectedCityId);
    ...
    private void loadData() {
        ...
        LiveData<Resource<List<com.macinternetservices.sablebusinessdirectory.viewobject.Comment>>> news = commentListViewModel.getCommentListData();
...
//            }
    ...
    private void replaceData(List<com.macinternetservices.sablebusinessdirectory.viewobject.Comment> commentList) {
