...
import com.macinternetservices.sablebusinessdirectory.databinding.FragmentCommentDetailBinding;
import com.macinternetservices.sablebusinessdirectory.ui.comment.detail.adapter.CommentDetailAdapter;
...
//            }
    ...
    private void sendComment() {
        ...
        if (description.equals("")) {
            ...
            prgDialog.get().show();
            commentDetailListViewModel.setSendCommentDetailPostDataObj(commentDetailListViewModel.commentId, loginUserId, description, selectedCityId);

        }
    }

    private void replaceData(List<com.macinternetservices.sablebusinessdirectory.viewobject.CommentDetail> commentList) {
