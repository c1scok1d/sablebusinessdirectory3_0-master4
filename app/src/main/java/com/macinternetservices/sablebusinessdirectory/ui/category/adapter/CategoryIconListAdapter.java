package com.macinternetservices.sablebusinessdirectory.ui.category.adapter;
...
import com.macinternetservices.sablebusinessdirectory.databinding.ItemHomeCategoryIconListBinding;
...
public class CategoryIconListAdapter extends DataBoundListAdapter<ItemCategory, ItemHomeCategoryIconListBinding> {
    ...
    protected ItemHomeCategoryIconListBinding createBinding(ViewGroup parent) {
        ...
        binding.getRoot().setOnClickListener(v -> {
            ItemCategory category = binding.getCat();
    ...
    @Override
    protected void bind(ItemHomeCategoryIconListBinding binding, ItemCategory item) {
        binding.setCat(item);
    }
