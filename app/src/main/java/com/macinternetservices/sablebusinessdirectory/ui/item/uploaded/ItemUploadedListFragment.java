package com.macinternetservices.sablebusinessdirectory.ui.item.uploaded;
...
import com.macinternetservices.sablebusinessdirectory.databinding.FragmentUploadedItemBinding;
...
public class ItemUploadedListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    @VisibleForTesting
    private AutoClearedValue<FragmentUploadedItemBinding> binding;
    private AutoClearedValue<ItemUploadedAdapter> itemListAdapter;
        ...
        ItemUploadedAdapter nvAdapter = new ItemUploadedAdapter(dataBindingComponent, new ItemUploadedAdapter.ItemListClickCallback() {
            ...
            public void onClick(Item item) {
                ...
                navigationController.navigateToItemUploadActivity(ItemUploadedListFragment.this.getActivity(), item,"","",
                        item.city,item.category,item.subCategory,item.defaultPhoto);
