package com.macinternetservices.sablebusinessdirectory.ui.category.categoryselection;
...
import com.macinternetservices.sablebusinessdirectory.databinding.FragmentCategorySelectionBinding;
                ...
                if (lastPosition == adapter.get().getItemCount() - 1) {
                    ...
                    if (!binding.get().getLoadingMore() && !itemCategoryViewModel.forceEndLoading) {
                        ...
                        if (connectivity.isConnected()) {
                            ...
                            itemCategoryViewModel.setNextPageLoadingStateObj(String.valueOf(Config.LIST_CATEGORY_COUNT),String.valueOf(itemCategoryViewModel.offset),selectedCityId);
                        }
                    }
                }
            }
