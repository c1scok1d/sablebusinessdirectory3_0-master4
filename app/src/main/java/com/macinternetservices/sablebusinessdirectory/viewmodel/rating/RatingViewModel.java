package com.macinternetservices.sablebusinessdirectory.viewmodel.rating;
...
import com.macinternetservices.sablebusinessdirectory.repository.rating.RatingRepository;
...
public class RatingViewModel extends PSViewModel {
    ...
    RatingViewModel(RatingRepository repository) {
        ...
        ratingPostData = Transformations.switchMap(ratingPostObj, obj -> {
            ...
            return repository.uploadRatingPostToServer(obj.title, obj.description, obj.rating, obj.cityId, obj.loginUserId, obj.itemId);
        });
    ...
    //Get Rating post
    public void setRatingPostObj(String title, String description, String rating, String cityId, String userId, String itemId) {
