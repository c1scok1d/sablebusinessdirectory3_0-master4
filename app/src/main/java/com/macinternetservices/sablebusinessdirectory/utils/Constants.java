...
Location Current_Location=new Location("");
    ...
    String CITY_CANCELLATION = "CITY_CANCELLATION";
    String CITY_TERMS = "CITY_TERMS";
    String CITY_ADDITIONAL_INFO =" CITY_ADDITIONAL_INFO";
    String CITY_ITEM_ID="CITY_ITEM_ID";
    ...
    int RESULT_CODE__MAP_BACK_ALL_LISTING_FILTERING = 200220;
