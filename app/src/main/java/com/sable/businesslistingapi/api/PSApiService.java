package com.sable.businesslistingapi.api;
...
public interface PSApiService {
    ...
    @GET("rest/items/get/api_key/{API_KEY}/id/{id}/city_id/{city_id}/login_user_id/{login_user_id}")
    LiveData<ApiResponse<Item>> getItemDetail(@Path("API_KEY") String apiKey, @Path("id") String Id, @Path("city_id") String cityId, @Path("login_user_id") String login_user_id);
    ...
    LiveData<ApiResponse<List<com.sable.businesslistingapi.viewobject.Comment>>> getCommentList(@Path("API_KEY") String apiKey, @Path("item_id") String itemId, @Path("limit") String limit, @Path("offset") String offset);
    ...
    LiveData<ApiResponse<List<com.sable.businesslistingapi.viewobject.CommentDetail>>> getCommentDetailList(@Path("API_KEY") String apiKey, @Path("header_id") String headerId, @Path("limit") String limit, @Path("offset") String offset);
    ...
    Call<User> postFBUser(@Path("API_KEY") String apiKey, @Field("facebook_id") String facebookId, @Field("user_name") String userName, @Field("user_email") String userEmail, @Field("profile_img_id") String profilePhotoUrl,@Field("device_token") String deviceToken);
    ...
    @GET("rest/subcategories/get/api_key/{API_KEY}/city_id/{city_id}")
    LiveData<ApiResponse<List<ItemSubCategory>>> getAllSubCategoryList(@Path("API_KEY") String apiKey, @Path("city_id") String city_id);

    @GET("rest/subcategories/get/api_key/{API_KEY}/city_id/{city_id}/cat_id/{cat_id}/limit/{limit}/offset/{offset}")
    LiveData<ApiResponse<List<ItemSubCategory>>> getSubCategoryList(@Path("API_KEY") String apiKey, @Path("city_id") String city_id, @Path("cat_id") String catId, @Path("limit") String limit, @Path("offset") String offset);

    @GET("rest/subcategories/get/api_key/{API_KEY}/city_id/{city_id}/limit/{limit}/offset/{offset}/cat_id/{cat_id}")
    LiveData<ApiResponse<List<ItemSubCategory>>> getSubCategoryListWithCatId(@Path("API_KEY") String apiKey, @Path("city_id") String city_id, @Path("cat_id") String catId, @Path("limit") String limit, @Path("offset") String offset);
    ...
    @GET("rest/feeds/get/api_key/{API_KEY}/city_id/{city_id}/limit/{limit}/offset/{offset}")
    LiveData<ApiResponse<List<Blog>>> getAllNewsFeedByCityId(@Path("API_KEY") String api_key, @Path("city_id") String cityId, @Path("limit") String limit, @Path("offset") String offset);

    @GET("rest/feeds/get/api_key/{API_KEY}/id/{id}/city_id/{city_id}")
    LiveData<ApiResponse<Blog>> getNewsById(@Path("API_KEY") String api_key, @Path("id") String id, @Path("city_id") String cityId);
...
//    @POST("rest/items/search/api_key/{API_KEY}/limit/{limit}/offset/{offset}/login_user_id/{login_user_id}/lat/{current_lat}/lng/{current_lng}/miles/23")
    ...
    @GET("rest/categories/get/api_key/{API_KEY}/city_id/{city_id}/limit/{limit}/offset/{offset}")
    ...
    @GET("rest/collections/get/api_key/{API_KEY}/limit/{limit}/offset/{offset}/city_id/{city_id}")
