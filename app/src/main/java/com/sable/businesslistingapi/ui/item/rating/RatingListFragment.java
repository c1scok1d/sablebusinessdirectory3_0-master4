...
import com.sable.businesslistingapi.databinding.FragmentRatingListBinding;
...
import com.sable.businesslistingapi.ui.item.rating.adapter.RatingListAdapter;
...
public class RatingListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().writeReviewButton.setOnClickListener(v -> Utils.navigateOnUserVerificationActivity(userIdToVerify, loginUserId, psDialogMsg, RatingListFragment.this.getActivity(), navigationController, RatingListFragment.this::getCustomLayoutDialog));
