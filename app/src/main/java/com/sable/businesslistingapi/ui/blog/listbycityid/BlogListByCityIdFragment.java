...
import com.sable.businesslistingapi.databinding.FragmentBlogListByCityIdBinding;
import com.sable.businesslistingapi.ui.blog.list.adapter.BlogListAdapter;
...
public class BlogListByCityIdFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initAdapters() {
        ...
        BlogListAdapter nvAdapter = new BlogListAdapter(dataBindingComponent, newsFeed -> navigationController.navigateToBlogDetailActivity(BlogListByCityIdFragment.this.getActivity(), newsFeed.id,newsFeed.cityId), this);
    ...
    protected void initData() {
        ...
        blogViewModel.setNewsFeedByCityIdObj(blogViewModel.cityId, String.valueOf(Config.LIST_NEW_FEED_COUNT_BY_CITY_ID), String.valueOf(blogViewModel.offset));
