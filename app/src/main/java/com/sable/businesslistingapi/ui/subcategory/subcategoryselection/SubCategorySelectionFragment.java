...
import com.sable.businesslistingapi.databinding.FragmentSubCategorySelectionBinding;
                ...
                if (lastPosition == subCategoryAdapter.get().getItemCount() - 1) {
                    ...
                    if (!binding.get().getLoadingMore() && !subCategoryViewModel.forceEndLoading) {
                        ...
                        if (connectivity.isConnected()) {
                            ...
                            subCategoryViewModel.setNextPageLoadingStateObj(selectedCityId,itemListViewModel.catSelectId, String.valueOf(Config.LIST_SUB_CATEGORY_COUNT), String.valueOf(subCategoryViewModel.offset));
                        }
                    }
                }
            }
