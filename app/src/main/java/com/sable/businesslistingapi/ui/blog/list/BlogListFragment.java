package com.sable.businesslistingapi.ui.blog.list;
...
import com.sable.businesslistingapi.databinding.FragmentBlogListBinding;
...
public class BlogListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initAdapters() {
        ...
        BlogListAdapter nvAdapter = new BlogListAdapter(dataBindingComponent, newsFeed -> navigationController.navigateToBlogDetailActivity(BlogListFragment.this.getActivity(), newsFeed.id,newsFeed.cityId), this);
