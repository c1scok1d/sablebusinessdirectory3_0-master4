package com.sable.businesslistingapi.ui.city.selectedcity;
...
import com.sable.businesslistingapi.databinding.FragmentSelectedCityBinding;
import com.sable.businesslistingapi.ui.category.adapter.CityCategoryAdapter;
import com.sable.businesslistingapi.ui.city.selectedcity.adapter.ItemCollectionRowAdapter;
...
import com.sable.businesslistingapi.ui.item.adapter.ItemPopularListAdapter;
...
public class SelectedCityFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
        ...
        binding.get().floatingActionButton.setOnClickListener(view -> {
            Utils.navigateOnUserVerificationActivity(userIdToVerify, loginUserId, psDialogMsg, getActivity(), navigationController, new Utils.NavigateOnUserVerificationActivityCallback() {
                ...
                public void onSuccess() {
                    navigationController.navigateToItemUploadActivity(SelectedCityFragment.this.getActivity(), null, "", "", null,
                            null, null, null);
                }
            });
        });
    ...
    protected void initAdapters() {
        ...
        ItemPopularListAdapter popularAdapter = new ItemPopularListAdapter(dataBindingComponent, new ItemPopularListAdapter.NewsClickCallback() {
            @Override
            public void onClick(Item item) {
                navigationController.navigateToSelectedItemDetail(SelectedCityFragment.this.getActivity(), item.id, item.name, cityViewModel.cityParameterHolder.id);
            }
        }, this);
    ...
    private void loadProducts() {
        ...
        recentItemViewModel.recentItemParameterHolder.city_id = selectedCityId;
