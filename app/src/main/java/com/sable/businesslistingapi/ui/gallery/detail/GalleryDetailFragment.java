...
import com.sable.businesslistingapi.databinding.FragmentGalleryDetailBinding;
...
import com.sable.businesslistingapi.utils.TouchImageView;
...
//        });
    ...
    protected void initData() {
        ...
        binding.get().clearImageView.setOnClickListener(view -> {
            if (getActivity() != null) {
                getActivity().finish();
            }
        });
