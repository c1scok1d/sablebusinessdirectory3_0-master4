package com.sable.businesslistingapi.ui.city.menu;
...
import com.sable.businesslistingapi.databinding.FragmentCityMenuBinding;
...
public class CityMenuFragment extends PSFragment {
    ...
    protected void initUIAndActions() {
        ...
        binding.get().collectionCardView.setOnClickListener(v -> navigationController.navigateToCollectionHeaderListActivity(getActivity()));

        binding.get().button2.setOnClickListener(new View.OnClickListener() {
            @Override
