package com.sable.businesslistingapi.ui.item.promote;
...
import com.sable.businesslistingapi.databinding.FragmentLoginUserPaidItemBinding;
...
import com.sable.businesslistingapi.ui.item.promote.adapter.ItemPromoteVerticalListAdapter;
        ...
        ItemPromoteVerticalListAdapter itemPromoteVerticalListAdapter = new ItemPromoteVerticalListAdapter(dataBindingComponent,
                new ItemPromoteVerticalListAdapter.NewsClickCallback() {
                    ...
                    public void onClick(ItemPaidHistory itemPaidHistory) {
                        navigationController.navigateToDetailActivity(LoginUserPaidItemFragment.this.getActivity(), itemPaidHistory.item);
                    }
                },this);
