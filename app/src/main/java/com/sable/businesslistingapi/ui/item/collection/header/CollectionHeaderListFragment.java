...
import com.sable.businesslistingapi.databinding.FragmentCollectionHeaderListBinding;
import com.sable.businesslistingapi.ui.item.collection.adapter.CollectionHeaderListAdapter;
...
public class CollectionHeaderListFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
                    ...
                    if (lastPosition == adapter.get().getItemCount() - 1) {
                        ...
                        if (!binding.get().getLoadingMore() && !itemCollectionViewModel.forceEndLoading) {
                            ...
                            if (connectivity.isConnected()) {
                                ...
                                itemCollectionViewModel.setNextPageCollectionHeaderListObj( String.valueOf(Config.ITEM_COUNT), String.valueOf(itemCollectionViewModel.offset), selectedCityId);
                            }
                        }
                    }
                }
        ...
        binding.get().swipeRefresh.setOnRefreshListener(() -> {
            ...
            // update live data
            itemCollectionViewModel.setCollectionHeaderListObj( selectedCityId, String.valueOf(Config.ITEM_COUNT), String.valueOf(itemCollectionViewModel.offset));
