package com.sable.businesslistingapi.ui.subcategory;
...
import com.sable.businesslistingapi.databinding.FragmentSubCategoryBinding;
...
import com.sable.businesslistingapi.ui.subcategory.adapter.SubCategoryAdapter;
...
public class SubCategoryFragment extends PSFragment implements DataBoundListAdapter.DiffUtilDispatchedInterface {
    ...
    protected void initUIAndActions() {
                    ...
                    if (lastPosition == adapter.get().getItemCount() - 1) {
                        ...
                        if (!binding.get().getLoadingMore() && !subCategoryViewModel.forceEndLoading) {
                            ...
                            if (connectivity.isConnected()) {
                                ...
                                subCategoryViewModel.setNextPageLoadingStateObj(selectedCityId,subCategoryViewModel.catId, String.valueOf(Config.LIST_CATEGORY_COUNT), String.valueOf(subCategoryViewModel.offset));
                            }
                        }
                    }
                }
        ...
        binding.get().swipeRefresh.setOnRefreshListener(() -> {
            ...
            // update live data
            subCategoryViewModel.setSubCategoryListData(selectedCityId,subCategoryViewModel.catId, String.valueOf(Config.LIST_CATEGORY_COUNT), String.valueOf(subCategoryViewModel.offset));
    ...
    protected void initAdapters() {
        SubCategoryAdapter nvAdapter = new SubCategoryAdapter(dataBindingComponent, subCategory -> {
            ...
            navigationController.navigateToHomeFilteringActivity(SubCategoryFragment.this.getActivity(), itemParameterHolder, subCategory.name, selectedCityLat, selectedCityLng, selectedCityName);
        },this);
