...
public class CommentDetail {
    ...
    public CommentDetail(@NonNull String id, @NonNull String cityId, String headerId, String userId, String detailComment, String status, String addedDate, String updatedDate, String addedDateStr, User user) {
        this.id = id;
        this.cityId = cityId;
