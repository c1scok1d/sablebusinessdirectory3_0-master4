...
import com.sable.businesslistingapi.repository.comment.CommentRepository;
...
public class CommentListViewModel extends PSViewModel {
    ...
    private MutableLiveData<com.sable.businesslistingapi.viewmodel.comment.CommentListViewModel.TmpDataHolder> sendCommentHeaderPostDataObj = new MutableLiveData<>();
    ...
    public void setSendCommentHeaderPostDataObj(String itemId,
        ...
        if (!isLoading) {
            com.sable.businesslistingapi.viewmodel.comment.CommentListViewModel.TmpDataHolder tmpDataHolder = new com.sable.businesslistingapi.viewmodel.comment.CommentListViewModel.TmpDataHolder();
