package com.sable.businesslistingapi.viewmodel.ItemPaidHistoryViewModel;
...
import com.sable.businesslistingapi.repository.itempaidhistory.ItemPaidHistoryRepository;
...
public class ItemPaidHistoryViewModel extends PSViewModel {
    ...
    ItemPaidHistoryViewModel(ItemPaidHistoryRepository itemPaidHistoryRepository) {
        ...
        sendItemPaidHistoryData = Transformations.switchMap(sendItemPaidHistoryObj, obj -> {
            ...
            return itemPaidHistoryRepository.uploadItemPaidToServer(obj.itemId, obj.amount, obj.startDate,
                    obj.howManyDay, obj.paymentMethod, obj.paymentMethodNonce,obj.startTimeStamp, obj.razorId);
        });
    ...
    public void setUploadItemPaidHistoryData(String itemId, String amount, String startDate, String howManyDay,
                                             String paymentMethod, String paymentMethodNonce, String startTimeStamp,String razorId) {
